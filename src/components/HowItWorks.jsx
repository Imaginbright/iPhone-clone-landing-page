      ...
      <div className="screen-max-width">
        ...
        <div className="hiw-text-container">
          ...
          <p className="hiw-text g_fadeIn mt-4">
            ...
            with incredibly detailed characters and environments. And with
            indusrty-leading speed and efficiency, A17 Pro takes fast to a whole
            new level.
          </p>
        </div>
